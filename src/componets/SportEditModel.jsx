...
const SportEditModel = ({ data }) => {
    const { _id, imageUrl, duration, destinationName, description, departureDate, country, category, price
    } = data;
